             ...
             <div class="description">
                 <div class="form-row">
                  <div class="col-md-4 mb-3">
                      ...
                      <input class="input" type="text" placeholder="Enter day" name="day" required>
                      
                    </div>
  
                  <div class="col-md-4 mb-3">
                      <label class="label" for="wdistance"><b>Walking</b></label>
                      <input class="input" type="text" placeholder="Enter distance(km)" name="wdistance" required>
                  </div>
  
                  <div class="col-md-4 mb-3">
                      <label class="label" for="rdistance"><b>Running</b></label>
                      <input class="input" type="text" placeholder="Enter distance(km)" name="rdistance" required>
                  </div>
  
                  <div class="col-md-4 mb-3">
                      <label class="label" for="cdistance"><b>Cycling</b></label>
                      <input class="input" type="text" placeholder="Enter distance(km)" name="cdistance" required>
                  </div>
                     
                  <div class="col-md-4 mb-3">
                      <label class="label" for="wtrain"><b>Weight Training</b></label>
                      <input class="input" type="text" placeholder="Enter time" name="wtrain" required>
                  </div>
  
                  <div class="col-md-4 mb-3">
                      <label class="label" for="pushup"><b>Push Ups</b></label>
                      <input class="input" type="text" placeholder="Enter count" name="pushup" required>
                  </div>

                  <div class="col-md-4 mb-3">
                    <label class="label" for="situp"><b>Sit Ups</b></label>
                    <input class="input" type="text" placeholder="Enter count" name="situp" required>
                </div>

                <div class="col-md-4 mb-3">
                    <label class="label" for="stretching"><b>Stretching Exercise</b></label>
                    <input class="input" type="text" placeholder="Enter time" name="stretching" required>
                </div>
                <br>
                <br>
                ...
                <input class="btn btn-outline-secondary btn-md" type="submit" name="save" value="Submit">
                <br>
                <br>
                <p><b>Instructions : Enter the date correctly and in order.</b></p>
                </div>
